...
def return_figures(countries=country_default):
  ...
  # first chart plots arable land from 1990 to 2020 in top 10 economies 
  # as a line chart
  graph_one = []
  ...
  df_one = df_one[(df_one['date'] == '2020') | (df_one['date'] == '1990')]
  ...
  layout_one = dict(title = 'Change in Hectares Arable Land <br> per Person 1990 to 2020',
  ...
  graph_two = []
  df_one.sort_values('value', ascending=False, inplace=True)
  df_one = df_one[df_one['date'] == '2020'] 
  ...
  layout_two = dict(title = 'Hectares Arable Land per Person in 2020',
                xaxis = dict(title = 'Country',),
                yaxis = dict(title = 'Hectares per person'),
                )

  # third chart plots percent of population that is rural from 1990 to 2020
  graph_three = []
  df_three = pd.DataFrame(data_frames[1])
  df_three = df_three[(df_three['date'] == '2020') | (df_three['date'] == '1990')]
  ...
  layout_four = dict(title = '% of Population that is Rural versus <br> % of Land that is Forested <br> 1990-2020',
